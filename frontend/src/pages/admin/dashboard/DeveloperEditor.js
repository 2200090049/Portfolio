      ...
      try {
        ...
        const response = await fetch(`${apiUrl}/graphql`, {
          ...
          body: JSON.stringify({
            query: `
              query {
                profile(portfolioType: "developer") {
                  portfolioType
                  name
                  title
                  tagline
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (errors) {
        ...
        setMessage({ type: 'success', text: '✅ Developer Profile updated successfully!' });
      ...
      <div className="editor-header">
        <div className="header-content">
          <h1 className="god-mode-title">
            <span className="gradient-text">GOD MODE</span> Developer Profile
          </h1>
          <p className="editor-subtitle">Configure your Developer portfolio settings</p>
        </div>
        <button 
          className="btn-save" 
      ...
      <form onSubmit={handleSubmit} className="editor-form">
        ...
        <div className="form-actions">
          <button type="submit" className="btn-primary" disabled={saving}>
            <FaSave /> {saving ? 'Saving...' : 'Save Developer Profile'}
          </button>
        </div>
      </form>
    </div>
