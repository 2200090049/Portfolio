...
const UXEditor = () => {
  ...
  const response = await fetch(`${apiUrl}/graphql`, {
      ...
      if (errors) {
        ...
        setMessage({ type: 'success', text: 'âœ… UX Designer Profile updated successfully!' });
    ...
    return (
      <div className="profile-editor">
        <div className="loading-container">
          ...
          <p>Loading UX Designer Profile...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="editor-header">
        <div className="header-content">
          <h1 className="god-mode-title">
            <span className="gradient-text">GOD MODE</span> UX Designer Profile
          </h1>
          <p className="editor-subtitle">Configure your UX Designer portfolio settings</p>
        </div>
        <button 
          className="btn-save" 
      ...
      <form onSubmit={handleSubmit} className="editor-form">
        ...
        <div className="form-actions">
          <button type="submit" className="btn-primary" disabled={saving}>
            <FaSave /> {saving ? 'Saving...' : 'Save UX Designer Profile'}
          </button>
        </div>
      </form>
    </div>
